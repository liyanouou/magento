 ...
 * @created    5th Dec, 2014 2:48pm
 * @author     Clarion magento team<magento@clariontechnologies.co.in>
 * @purpose    Manage manage one step checkout onestep checkout actions 
 * @copyright  Copyright (c) 2014 Clarion Technologies Pvt.Ltd
 * @license    http://opensource.org/licenses/osl-3.0.php  Open Software License
 */ 
class Clarion_OnestepCheckout_IndexController extends Mage_Checkout_Controller_Action
{
    ...
    public function saveOrderAction()
    {
	        ...
	        $_SESSION['git_wrap']= $_POST['giftwrap'];
        	$result = array();
        	try {

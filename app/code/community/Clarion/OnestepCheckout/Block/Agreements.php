 ...
 *
 * @category    Catalog
 * @package     Clarion_OnestepChekout
 * @created     10th May 3.52pm
 * @author      Clarion magento team<magento@clariontechnologies.co.in>
 * @purpose     Onestep checkout agreements block 
 * @copyright   Copyright (c) 2014 Clarion Technologies Pvt.Ltd
 * @license     http://opensource.org/licenses/osl-3.0.php  Open Software License
 */
class Clarion_OnestepCheckout_Block_Agreements extends Mage_Core_Block_Template
{
